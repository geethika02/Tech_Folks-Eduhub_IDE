...
$(document).ready(function () {
    ...
    require(["vs/editor/editor.main", "monaco-vim", "monaco-emacs"], function (ignorable, MVim, MEmacs) {
        ...
        layout.on("initialised", function () {
            ...
            $("#site-navigation").css("border-bottom", "1px solid red");
            sourceEditor.focus();
            editorsUpdateFontSize(fontSize);
        });
...
section	.rodata\n\
\n\
msg	db 'Welcome to Eduhub IDE', 0xa\n\
len	equ	$ - msg\n\
";

var bashSource = "echo \"Welcome to Eduhub IDE\"";

var basicSource = "PRINT \"Welcome to Eduhub IDE\"";

var cSource = "\
#include <stdio.h>\n\
\n\
int main(void) {\n\
    printf(\"Welcome to Eduhub IDE\\n\");\n\
    return 0;\n\
}\n\
";
...
public class Hello {\n\
    public static void Main() {\n\
        System.Console.WriteLine(\"Welcome to Eduhub IDE\");\n\
    }\n\
}\n\
";
...
using namespace std;\n\
int main() {\n\
    cout << \"Welcome to Eduhub IDE\" << std::endl;\n\
    return 0;\n\
}\n\
";

var clojureSource = "(println \"Welcome to Eduhub IDE\")\n";

var cobolSource = "\
IDENTIFICATION DIVISION.\n\
PROGRAM-ID. MAIN.\n\
PROCEDURE DIVISION.\n\
DISPLAY \"Welcome to Eduhub IDE\".\n\
STOP RUN.\n\
";

var lispSource = "(write-line \"Welcome to Eduhub IDE\")";
...
void main()\n\
{\n\
    writeln(\"Welcome to Eduhub IDE\");\n\
}\n\
";

var elixirSource = "IO.puts \"Welcome to Eduhub IDE\"";

var erlangSource = "\
main(_) ->\n\
    io:fwrite(\"Welcome to Eduhub IDE\\n\").\n\
";
...
\n\
Here is an example of compiled \"Welcome to Eduhub IDE\" NASM program.\n\
Content of compiled binary is Base64 encoded and used as source code.\n\
\n\
https://ide.judge0.com/?kS_f\n\
";

var fsharpSource = "printfn \"Welcome to Eduhub IDE\"\n";

var fortranSource = "\
program main\n\
    print *, \"Welcome to Eduhub IDE\"\n\
end\n\
";
...
\n\
func main() {\n\
    fmt.Println(\"Welcome to Eduhub IDE\")\n\
}\n\
";

var groovySource = "println \"Welcome to Eduhub IDE\"\n";

var haskellSource = "main = putStrLn \"Welcome to Eduhub IDE\"";

var javaSource = "\
public class Main {\n\
    public static void main(String[] args) {\n\
        System.out.println(\"Welcome to Eduhub IDE\");\n\
    }\n\
}\n\
";

var javaScriptSource = "console.log(\"Welcome to Eduhub IDE\");";

var kotlinSource = "\
fun main() {\n\
    println(\"Welcome to Eduhub IDE\")\n\
}\n\
";

var luaSource = "print(\"Welcome to Eduhub IDE\")";
...
var ocamlSource = "print_endline \"Welcome to Eduhub IDE\"";

var octaveSource = "printf(\"Welcome to Eduhub IDE\\n\");";
...
var plainTextSource = "Welcome to Eduhub IDE\n";

var prologSource = "\
:- initialization(main).\n\
main :- write('Welcome to Eduhub IDE\\n').\n\
";

var pythonSource = "print(\"Welcome to Eduhub IDE\")";

var rSource = "cat(\"Welcome to Eduhub IDE\\n\")";

var rubySource = "puts \"Welcome to Eduhub IDE\"";
...
var typescriptSource = "console.log(\"Welcome to Eduhub IDE\");";

var vbSource = "\
Public Module Program\n\
   Public Sub Main()\n\
      Console.WriteLine(\"Welcome to Eduhub IDE\")\n\
   End Sub\n\
End Module\n\
";
